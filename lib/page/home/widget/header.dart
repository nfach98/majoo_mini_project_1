...
class Header extends StatelessWidget {
  const Header({Key? key, this.rating = 4.9, this.sales = 542, this.imageName = 'drone_1.png', this.onPressed})
      : super(key: key);
  final double rating;
  final int sales;
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: RadialGradient(
          ...
          center: width >= 480 ? const Alignment(0, -.5) : const Alignment(.5, 0),
          radius: 2.5,
        ),
      ),
      child: Stack(
        children: [
          Padding(
            ...
            child: Align(
              alignment: width >= 480 ? Alignment.topCenter : Alignment.centerRight,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  if (width >= 480) const SizedBox(height: 16) else const Spacer(),
                  ElevatedButton(
                    onPressed: onPressed ?? () {},
